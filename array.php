...
$cartas = [["palo" => "corazones", "valor" => "1", "imagen" => "cor_1.png"],
                   ...
                   ["palo" => "corazones", "valor" =>"11", "imagen" => "cor_j.png"],
                   ["palo" => "corazones", "valor" =>"12", "imagen" => "cor_q.png"],
                   ["palo" => "corazones", "valor" =>"13", "imagen" => "cor_k.png"],
                   ...
                   ["palo" => "picas", "valor" =>"11", "imagen" => "pic_j.png"],
                   ["palo" => "picas", "valor" =>"12", "imagen" => "pic_q.png"],
                   ["palo" => "picas", "valor" =>"13", "imagen" => "pic_k.png"],
                   ...
                   ["palo" => "rombos", "valor" =>"11", "imagen" => "rom_j.png"],
                   ["palo" => "rombos", "valor" =>"12", "imagen" => "rom_q.png"],
                   ["palo" => "rombos", "valor" =>"13", "imagen" => "rom_k.png"],
                   ...
                   ["palo" => "trevoles", "valor" =>"11", "imagen" => "tre_j.png"],
                   ["palo" => "trevoles", "valor" =>"12", "imagen" => "tre_q.png"],
                   ["palo" => "trevoles", "valor" =>"13", "imagen" => "tre_k.png"],
                ];